...
$(() => {
  ...
  $('#submit-lineup1').on('click', events.onCreateLineup1)
  $('#submit-lineup2').on('click', events.onCreateLineup2)
  $('#submit-lineup3').on('click', events.onCreateLineup3)
  $('#enter-lineup').on('click', events.onCreateEntry)
